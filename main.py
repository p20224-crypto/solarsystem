...
planet_data = {
    ...
    '위성_이미지': {
        '달': 'https://search.pstatic.net/sunny/?src=https%3A%2F%2Fr1.community.samsung.com%2Ft5%2Fimage%2Fserverpage%2Fimage-id%2F8121811i5158A35A19FC5C45%3Fv%3Dv2&type=sc960_832'
    },
},
    '화성': {
    ...
    '토성': {
        '특징': '거대한 고리와 많은 위성을 가진 행성.',
        '대표적인_위성': '타이탄, 엔셀라두스, 미마스',
        '위성_특징': {
            '타이탄': '지금까지 관측된 토성의 위성 가운데 가장 크고, 겉보기 등급이 8등급 수준으로, 소형 천체망원경을 사용하면 그리 어렵지 않게 관찰할 수 있다.',
            '엔셀라두스': '지름이 504km밖에 되지 않은 매우 작은 위성으로 영구보다 작은 크기이다.',
            '미마스': '토성의 7번째로 큰 자연 위성으로 자체 중력으로 인해 모양이 거의 둥근 것으로 알려진 가장 작은 천체이다.',
        },
    },
    '천왕성': {
        ...
        '위성_특징': {
            '세토보스': '천왕성의 가장 바깥쪽 역핵을 하며 불규칙한 위성 중 하나이다.',
            '티타니아': '천왕성의 위성들 중 가장 크다.',
            '미란다': '천왕성의 둥근 다섯 개의 위성 중 가장 작고 가장 안쪽에 위치한 위성.',
        },
    },
    '해왕성': {
        '특징': '푸른색을 띠는 가스 행성, 강력한 바람과 폭풍이 특징.',
