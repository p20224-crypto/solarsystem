...
planet_data = {
    ...
    '목성': {
        ...
        '위성_특징': {
            '이오': '펴균 반지름이 1.800km 정도로 달과 비슷한 크기이다.',
            '유로파': '표면 아래에 거대한 지하 바다가 존재할 가능성이 높아 태양계 내 생명체 존재 후보지로 주목받고 있습니다.',
            '가니메데': '반지름 2.634km에 지구 질량의 약 2.5%의 질량이로, 현재까지 발견된 태양계 위성 중 가장 크다.',
            '칼리스토': '태양계에서 3번째로 큰 위성이고, 행성 분화율은 태양계에서 제일 낮다.',
        },
    },
}
    '토성': {
